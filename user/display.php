                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <ul id="generalTab" class="nav nav-tabs responsive">
                            ...
                            <li><a href="album.php">Setings</a></li>
                        </ul>
                                ...
                                <div class="row">
                                       <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p>Album Name:<?php echo $albumfetch['aname'];?><br>Date of upload:<?php echo date("l, d/m/Y",$albumfetch['time']);?><br>Description:<?php echo $albumfetch['description'];?></p></div>
                                        </div>
                                    <?php    
                                            $mobile=$_SESSION['user']['mobile'];
                                            $albumdisplay=mysqli_query($con,"SELECT * from `album` where `albumid`='$albumid'");
                                            echo "<form method='get' action='display.php'>";
                                            while($imagefetch=mysqli_fetch_assoc($image)){
                                                echo "<div class='col-sm-6 col-md-3'><a href='single.php?imageid=".$imagefetch['imageid']."' class='thumbnail' rel='prettyPhoto'><img src='albums/".$imagefetch['albumid']."/".$imagefetch['image']."' width='300' height='180'></a><center>".$imagefetch['aname']."</center></div>";
                                            }
                                            echo "</form>";
